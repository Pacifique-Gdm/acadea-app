...
const report: SecretaryReport = { id: "r1", reportNumber: "RAP-001", type: "meeting_minutes", title: "Réunion pédagogique", documentDate: "2026-08-06", startTime: "08:00", endTime: "09:00", structuredContent: { lieu: "Salle Polyvalente", participants: "Direction et enseignants", "points abordés": "Résultats trimestriels", décisions: "Suivi hebdomadaire", recommandations: "Accompagnement renforcé" }, signatories: [{ id: "s1", name: "Directeur Test" }], status: "draft", authorId: "u1", authorName: "Secrétaire École", schoolId: "school-1", schoolYearId: "year-1", createdAt: "2026-08-06", updatedAt: "2026-08-06" };
