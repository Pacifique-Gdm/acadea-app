...
beforeEach(async () => {
  ...
  for (const [path, value] of Object.entries({
    ...
    "users/school_admin-reader": { id: "school_admin-reader", role: "school_admin", schoolId: "school-a", status: "active" },
    "users/secretary-reader": { id: "secretary-reader", role: "secretary", schoolId: "school-a", status: "active" },
    "users/cashier-reader": { id: "cashier-reader", role: "cashier", schoolId: "school-a", status: "active" },
