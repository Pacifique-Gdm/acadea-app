...
describe("outils pédagogiques Enseignant",()=>{
  ...
  it("limite les élèves à la classe active affectée",()=>expect(studentsForAssignment([{id:"1",schoolId:"s",schoolYearId:"y",classId:"c",status:"ACTIVE"},{id:"2",schoolId:"s",schoolYearId:"y",classId:"x",status:"ACTIVE"},{id:"3",schoolId:"s",schoolYearId:"y",classId:"c",status:"TRANSFERRED"}] as Student[],assignment).map(item=>item.id)).toEqual(["1"]));
