...
export function PlatformModule({
  ...
  return (
    <div className="min-h-screen max-w-full overflow-x-hidden bg-[#f6f8fb] pb-24 text-ink">
      ...
      <MobileBottomNavigation ariaLabel="Navigation Super Administrateur" items={platformTabs} activeId={platformView} onSelect={setPlatformView} maxWidthClass="max-w-2xl" trailingItem={showInstallButton ? <InstallPwaNavButton onInstall={onInstallPwa} /> : undefined} />
