...
import { generateReceiptPdf, money, pdfInfoGrid, pdfSection, pdfTable, renderAcadPdfPreview } from "./utils/pdf";
...
import { buildFeeTargetChoices, feeTargetClassName, formatFeeTargetValue } from "./utils/feeTargets";
  ...
  if (validateDisciplineDirector(user)) {
    return (
      <DisciplinePortal
        ...
        MessagesModuleComponent={MessagesModule}
        createId={uid}
