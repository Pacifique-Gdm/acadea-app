import {describe,expect,it} from "vitest";import {completedStudyTimetables,currentStudyTimetable,detectAvailabilityConflicts,getActiveCoursePeriods,getNonTeachingPeriods,isRestDay,schedulePeriodLabel,sortTimetableEntriesForDisplay,studyDayLabel,teacherAvailableAt,validTimeRange,validatePeriod} from "./studySchedule";import type {SchedulePeriod,TeacherAvailability,Timetable,TimetableEntry} from "./studyTypes";
