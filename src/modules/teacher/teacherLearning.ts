...
export function studentsForAssignment(students:Student[],assignment:PedagogicalAssignment){return students.filter(student=>studentBelongsToAssignment(student,assignment));}
